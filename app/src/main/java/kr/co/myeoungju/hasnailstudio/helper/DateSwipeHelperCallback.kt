package kr.co.myeoungju.hasnailstudio.helper
...
class DateSwipeHelperCallback(private val recyclerViewAdapter : DateRecyclerAdapter)  : ItemTouchHelper.Callback() {
